...
export const content: Record<'en' | 'ar', Translation> = {
  en: {
    ...
    hero: {
      ...
      title: "Feed via Circular Economy",
      subtitle: "Revolutionizing the Saudi agricultural sector by transforming industrial food waste into high-quality, nutrient-dense livestock feed through AI & Engineering.",
  ...
  ar: {
    ...
    hero: {
      ...
      title: "أعلاف عبر الاقتصاد الدائري",
      subtitle: "إحداث نقلة نوعية في القطاع الزراعي السعودي من خلال تحويل مخلفات الطعام الصناعية إلى أعلاف عالية الجودة باستخدام الذكاء الاصطناعي.",
