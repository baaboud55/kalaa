      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2 md:gap-3 cursor-pointer shrink-0" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <img src="/logo.jpeg" alt="Kalaa Logo" className="h-10 md:h-12 w-auto object-contain rounded bg-white" />
            <span className={`font-bold text-xl md:text-2xl tracking-tight ${isScrolled ? 'text-brand-900' : 'text-white'}`}>
              Kalaa
            </span>
          </div>
